...
if __name__ == '__main__':
  ...
  output_file = MEDIA_DST / 'mu_failover_histogram.png'
  
  results = pd.read_csv("results/mu_failover.csv")
  data = results['failover_time_us'].values
  ...
  # Labels and title
  ax.set_xlabel('Mu Failover Latency (µs)', fontsize=12, fontweight='bold')
  ax.set_ylabel('Frequency', fontsize=12, fontweight='bold')
  ax.set_title(f'Failover Latency Distribution (n={len(data)})', 
                fontsize=14, fontweight='bold')
