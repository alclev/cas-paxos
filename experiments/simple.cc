...
int main(int argc, char* argv[]) {
  ...
  outfile << "lat_avg_us,lat_50p_us,lat_99p_us,lat_99_9p_us,throughput_ops_s\n";
  ...
  while (ROMULUS_STOPWATCH_RUNTIME(ROMULUS_MICROSECONDS) < static_cast<uint64_t>(testtime_us.count())) {
